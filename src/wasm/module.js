var Module = (function () {
  ...
  return function (Module) {
    ...
    var _grapheme_bigint_add_in_place = (Module[
      '_grapheme_bigint_add_in_place'
    ] = function () {
      return Module['asm']['h'].apply(null, arguments)
    })
    var _grapheme_bigint_allocate_words = (Module[
      '_grapheme_bigint_allocate_words'
    ] = function () {
      return Module['asm']['i'].apply(null, arguments)
    })
    var _grapheme_bigint_external_init = (Module[
      '_grapheme_bigint_external_init'
    ] = function () {
      return Module['asm']['j'].apply(null, arguments)
    })
    var _grapheme_bigint_get_sign = (Module[
      '_grapheme_bigint_get_sign'
    ] = function () {
      return Module['asm']['k'].apply(null, arguments)
    })
    var _grapheme_bigint_get_word_count = (Module[
      '_grapheme_bigint_get_word_count'
    ] = function () {
      return Module['asm']['l'].apply(null, arguments)
    })
    var _grapheme_bigint_get_words = (Module[
      '_grapheme_bigint_get_words'
    ] = function () {
      return Module['asm']['m'].apply(null, arguments)
    })
    var _grapheme_bigint_init_from_single_word = (Module[
      '_grapheme_bigint_init_from_single_word'
    ] = function () {
      return Module['asm']['n'].apply(null, arguments)
    })
    var _grapheme_bigint_multiply_in_place = (Module[
      '_grapheme_bigint_multiply_in_place'
    ] = function () {
