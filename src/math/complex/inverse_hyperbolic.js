...
export const Arccosh = z =>
  Ln(
    Add(z, Multiply(Sqrt(Add(z, Complex.One)), Sqrt(Subtract(z, Complex.One))))
  )

// arctanh(z) = 1/2 * ln( (1+z) / (1-z) )
export const Arctanh = z =>
  Ln(Divide(Add(Complex.One, z), Subtract(Complex.One, z))).scale(1 / 2)
...
export const ArctanhBranched = (z, branch = 0) =>
  LnBranched(
    Divide(Add(Complex.One, z), Subtract(Complex.One, z)),
    branch
  ).scale(1 / 2)

export const ArcsechBranched = (z, branch = 0) =>
  ArccoshBranched(Divide(Complex.One, z), branch)

// arccsch(z) = arcsinh(1/z)
export const ArccschBranched = (z, branch = 0) =>
  ArcsinhBranched(Divide(Complex.One, z), branch)

// arccoth(z) = arctanh(1/z)
export const ArccothBranched = (z, branch = 0) =>
  ArctanhBranched(Divide(Complex.One, z), branch)
