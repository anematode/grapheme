...
const pointInterface = constructInterface({
  interface: {
    position: {
      description:
        'Position of the point, potentially under a plot transformation',
  ...
  internal: {
    pos: {
      type: 'Vec2',
      computed: 'none' /* No defaults, no user value, no nothing */
    },
...
export class PointElement extends Element {
  ...
  _update () {
    ...
    this.internal.renderInfo = {
      instructions: { type: 'triangle_strip', color, vertices: circleVertices }
    }
  }
}
